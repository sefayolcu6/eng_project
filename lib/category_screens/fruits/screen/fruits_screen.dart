...
class _FruitsScreenState extends State<FruitsScreen> {
  ...
  void nextQuestion(String result) {
    if (FruitsQuestions.questions[currentQuestionIndex]["Result"] == result) {
      correctPiece++;
      setState(() {
        isTrueResult = true;
      });
        ...
        children: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
                ...
                onPressed: () {
                  if (FruitsQuestions.questions[currentQuestionIndex]
                          ["Index"] ==
                      FruitsQuestions.questions.length) {
                    errorFlushbar(
          ...
          Padding(
            ...
            child: Align(
              ...
              child: CircleAvatar(
                ...
                child: Text(
                  FruitsQuestions.questions[currentQuestionIndex]["Index"]
                      .toString(),
            ...
            child: Column(
              ...
              children: [
                Image.asset(
                  ...
                  FruitsQuestions.questions[currentQuestionIndex]["Image"]
                      .toString(),
                ),
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        FruitsQuestions.questions[currentQuestionIndex]["Name"]
                            .toString(),
                        style: TextStyle(
                            fontSize: 20,
                ...
                Wrap(
                  children: [
                    appButton(
                      ...
                      text: FruitsQuestions.questions[currentQuestionIndex]
                          ["Options"][0],
                    ),
                    appButton(
                      context: context,
