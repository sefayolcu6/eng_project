          ...
          Padding(
            ...
            child: Align(
              ...
              child: CircleAvatar(
                ...
                child: Text(
                  FurnituresQuestions.questions[currentQuestionIndex]["Index"]
                      .toString(),
            ...
            child: Column(
              ...
              children: [
                Image.asset(
                  ...
                  FurnituresQuestions.questions[currentQuestionIndex]["Image"]
                      .toString(),
                ),
                SizedBox(
                ...
                Wrap(
                  children: [
                    appButton(
                      ...
                      text: FurnituresQuestions.questions[currentQuestionIndex]
                          ["Options"][0],
                    ),
                    appButton(
                      context: context,
